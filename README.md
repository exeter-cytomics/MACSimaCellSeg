...
**Automatic cell segmentation workflows for MACSima multiplex images**
...
MACSimaCellSeg is a research and development repository focused on automatic nuclear and whole-cell segmentation of MACSima multiplex images.
...
Multiplex platforms such as MACSima generate high-dimensional image data, where each region of interest can contain many marker channels acquired across multiple imaging cycles. These data provide rich biological information but also create important computational challenges for image analysis.
...
1. Test **Cellpose-SAM** on MACSima image data.
2. Test **InstanSeg** on MACSima image data.
...
8. Explore future fine-tuning or modification of segmentation models for MACSima-specific segmentation.
...
This repository is designed to test, develop and compare multiple segmentation approaches.
